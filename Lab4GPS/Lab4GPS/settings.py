...
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'wspq ihbo igxj fqto')  # Replace with your app password
DEFAULT_FROM_EMAIL = 'SomaNet <muenisarah159@gmail.com>'
