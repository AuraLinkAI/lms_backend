...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'muenisarah159@gmail.com')  # Replace with your email
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'weri buoa uudc xrf')  # Replace with your app password
DEFAULT_FROM_EMAIL = 'SomaNet Support <muenisarah159@gmail.com>'
